...
public class RegistroHuesped extends JFrame implements ActionListener {
	...
	private void iniciarComponentes() {
		...
		lblFechaN.setFont(new Font("Arial", Font.PLAIN, 14));
		lblFechaN.setBounds(576, 256, 255, 14);
		...
		lblImagen.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/imagenes/registro.png")));
		lblImagen.setBounds(0, 0, 502, 556);
		...
		lblTitulo.setBounds(576, 74, 198, 42);
		contentPane.add(lblTitulo);
		
		JLabel lblReserva = new JLabel("Número de Reserva");
		lblReserva.setFont(new Font("Arial", Font.PLAIN, 14));
		lblReserva.setBounds(578, 455, 253, 14);
	...
	public void agregarIdReserva(int id_reserva) {
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == btnGuardar) {
			String mensaje = guardarHuesped();	
			if(mensaje.equals("Exito")) {
				miCoordinador.mostrarExito();
			}
		}
		...
		if(e.getSource() == btnSalir) {
			...
			miCoordinador.ocultarRegistroHuesped();			
		}		
	}
	
	private String guardarHuesped() {
		String mensaje = "";
